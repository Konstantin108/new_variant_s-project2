        ...
        <div class="main_content center">
                ...
                <ul class="left_menu__product">
                    <li class="left_menu_list">
                        <details class="left__details">
                            <summary class="left__summary">Category</summary>
            ...
            <div class="right_content_block ">
                ...
                <div class="products_sort ">
                    <div class="featured_link product_link">
                        <div class="block__featured">
                            <div class="block__self1"><img src="../assets/img/product_content1.jpg" alt="photo___1"
                                ...
                                <div class="sub__hover">
                                    <a href="#" class="box__sub_button sub__left"></a>
                                    <a href="#" class="box__sub_button sub__right"></a>
                                </div>
                            </div>
                    ...
                    <div class="featured_link product_link">
                        <div class="block__featured">
                            <div class="block__self1"><img src="../assets/img/product_content2.jpg" alt="photo___2"
                                                           class="photo___2 product__photo">
                                <a href="single_page.html" class="cart__hover"> <img src="../assets/img/cart_hover.svg"
                                                                                     alt="cart_hover_img"
                                                                                     class="cart_hover_img">
                                    <p class="hover_text">Add to Cart</p>
                    ...
                    <div class="featured_link product_link">
                        <div class="block__featured">
                            <div class="block__self1"><img src="../assets/img/product_content3.jpg" alt="photo___3"
                                                           class="photo___3 product__photo">
                                <a href="single_page.html" class="cart__hover"> <img src="../assets/img/cart_hover.svg"
                                                                                     alt="cart_hover_img"
                                                                                     class="cart_hover_img">
                                    <p class="hover_text">Add to Cart</p>
                    ...
                    <div class="featured_link product_link">
                        <div class="block__featured">
                            <div class="block__self1"><img src="../assets/img/product_content4.jpg" alt="photo___4"
                                                           class="photo___4 product__photo">
                                <a href="single_page.html" class="cart__hover"> <img src="../assets/img/cart_hover.svg"
                                                                                     alt="cart_hover_img"
                                                                                     class="cart_hover_img">
                                    <p class="hover_text">Add to Cart</p>
                    ...
                    <div class="featured_link product_link">
                        <div class="block__featured">
                            <div class="block__self1"><img src="../assets/img/product_content5.jpg" alt="photo___5"
                                                           class="photo___5 product__photo">
                                <a href="single_page.html" class="cart__hover"> <img src="../assets/img/cart_hover.svg"
                                                                                     alt="cart_hover_img"
                                                                                     class="cart_hover_img">
                                    <p class="hover_text">Add to Cart</p>
                    ...
                    <div class="featured_link product_link">
                        <div class="block__featured">
                            <div class="block__self1"><img src="../assets/img/product_content6.jpg" alt="photo___6"
                                                           class="photo___6 product__photo">
                                <a href="single_page.html" class="cart__hover"> <img src="../assets/img/cart_hover.svg"
                                                                                     alt="cart_hover_img"
                                                                                     class="cart_hover_img">
                                    <p class="hover_text">Add to Cart</p>
                    ...
                    <div class="featured_link product_link">
                        <div class="block__featured">
                            <div class="block__self1"><img src="../assets/img/product_content7.jpg" alt="photo___7"
                                                           class="photo___7 product__photo">
                                <a href="single_page.html" class="cart__hover"> <img src="../assets/img/cart_hover.svg"
                                                                                     alt="cart_hover_img"
                                                                                     class="cart_hover_img">
                                    <p class="hover_text">Add to Cart</p>
                    ...
                    <div class="featured_link product_link">
                        <div class="block__featured">
                            <div class="block__self1"><img src="../assets/img/product_content8.jpg" alt="photo___8"
                                                           class="photo___8 product__photo">
                                <a href="single_page.html" class="cart__hover"> <img src="../assets/img/cart_hover.svg"
                                                                                     alt="cart_hover_img"
                                                                                     class="cart_hover_img">
                                    <p class="hover_text">Add to Cart</p>
                    ...
                    <div class="featured_link product_link">
                        <div class="block__featured">
                            <div class="block__self1"><img src="../assets/img/product_content9.jpg" alt="photo___9"
                                                           class="photo___9 product__photo">
                                <a href="single_page.html" class="cart__hover"> <img src="../assets/img/cart_hover.svg"
                                                                                     alt="cart_hover_img"
                                                                                     class="cart_hover_img">
                                    <p class="hover_text">Add to Cart</p>
                ...
                <div class="footer__for_product ">
                    ...
                    <a href="#" class="view"><b>View All</b></a></div>
            </div>
        </div>
        <div class="clearfix"></div>
